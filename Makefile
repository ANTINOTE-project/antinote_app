...
build-playstore-release-bundle:
	env ORG_GRADLE_PROJECT_dev.steenbakker.mobile_scanner.useUnbundled=true flutter build appbundle --flavor=prodplaystore --obfuscate --split-debug-info=./debug-info --dart-define=protobuf.omit_enum_names=true