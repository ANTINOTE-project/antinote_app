...
class SerializedAccountRegistry extends $pb.GeneratedMessage {
  factory SerializedAccountRegistry({
  ...
  SerializedAccountRegistry._();

  factory SerializedAccountRegistry.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SerializedAccountRegistry.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SerializedAccountRegistry',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'antinote_app'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SerializedAccountRegistry clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SerializedAccountRegistry copyWith(
          void Function(SerializedAccountRegistry) updates) =>
      super.copyWith((message) => updates(message as SerializedAccountRegistry))
          as SerializedAccountRegistry;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SerializedAccountRegistry create() => SerializedAccountRegistry._();
  @$core.override
  SerializedAccountRegistry createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static SerializedAccountRegistry getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SerializedAccountRegistry>(create);
  static SerializedAccountRegistry? _defaultInstance;
