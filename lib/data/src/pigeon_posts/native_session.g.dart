...
abstract class PollingManager {
  ...
  Future<bool> askToTakePolling(String accountUid);

  Future<void> startPolling(String accountUid);

  Future<void> serverSignatureChanged(String accountUid, String newServerSignature);

  Future<void> pollingUpdated(String accountUid, PollingState newState);
    ...
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            final bool output = await api.askToTakePolling(arg_accountUid);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final String arg_accountUid = args[0]! as String;
          try {
            await api.startPolling(arg_accountUid);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            await api.serverSignatureChanged(arg_accountUid, arg_newServerSignature);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            await api.pollingUpdated(arg_accountUid, arg_newState);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
