...
class AccountStorageWidget extends InheritedWidget {
  const AccountStorageWidget({super.key, required this.storage, required super.child});

  final AccountStorage storage;

  static AccountStorageWidget of(BuildContext context) {
    final AccountStorageWidget? result = context.dependOnInheritedWidgetOfExactType<AccountStorageWidget>();
