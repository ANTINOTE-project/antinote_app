...
class NativeSessionManager {
  ...
  Future<void> setCurrentAccountsListener(List<String> accountUid) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeSessionManager.setCurrentAccountsListener$pigeonVar_messageChannelSuffix';
  ...
  Future<ScheduledTask> scheduleTask(String accountUid, List<String> channels, int? lastSessionVersion) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeSessionManager.scheduleTask$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<int?> finishTask(String accountUid, int taskId, Uint8List? newSession) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeSessionManager.finishTask$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<int> registerSession(String accountUid, Uint8List session) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeSessionManager.registerSession$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<PollingState> getPollingState(String accountUid) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeSessionManager.getPollingState$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> updatePollingState(String accountUid, PollingState newState, String? newServerSignature) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeSessionManager.updatePollingState$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class PollingManager {
  ...
  static void setUp(PollingManager? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.antinote_ui.PollingManager.askToTakePolling$messageChannelSuffix', pigeonChannelCodec,
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.antinote_ui.PollingManager.startPolling$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.antinote_ui.PollingManager.serverSignatureChanged$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
