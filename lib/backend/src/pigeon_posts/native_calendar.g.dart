...
class NativeCalendarManager {
  ...
  Future<List<ExistingCalendarEventEntry>> listExisting(String accountUid, int calendarId) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeCalendarManager.listExisting$pigeonVar_messageChannelSuffix';
  ...
  Future<List<ExistingCalendarEntry>> listCalendars(String accountUid) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeCalendarManager.listCalendars$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> deleteCalendar(String accountUid, int calendarId) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeCalendarManager.deleteCalendar$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> insertNew(List<NewRecurringCalendarEventEntry> entries) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeCalendarManager.insertNew$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> deleteExisting(List<ExistingCalendarEventEntry> entries) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeCalendarManager.deleteExisting$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<ExistingCalendarEntry> insertNewCalendar(NewCalendarEntry calendar) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.antinote_ui.NativeCalendarManager.insertNewCalendar$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
