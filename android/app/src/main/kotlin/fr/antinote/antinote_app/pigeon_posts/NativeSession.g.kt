          ...
          channel.setMessageHandler { message, reply ->
            ...
            api.scheduleTask(accountUidArg, channelsArg, lastSessionVersionArg, debugLabelArg) { result: Result<ScheduledTask> ->
              ...
              if (error != null) {
                ...
                reply.reply(NativeSessionPigeonUtils.wrapResult(data))
              }
            }
          }
        } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.finishTask(accountUidArg, taskIdArg, newSessionArg) { result: Result<Long?> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NativeSessionPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.registerSession(accountUidArg, sessionArg) { result: Result<Long> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NativeSessionPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val accountUidArg = args[0] as String
            api.getPollingState(accountUidArg) { result: Result<PollingState> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NativeSessionPigeonUtils.wrapError(error))
              } else {
